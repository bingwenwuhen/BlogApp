  ...
  <div id="page">
    <div id="content">
      ...
      <ul class="blog-medium">
        <li>
          <div class="blog-medium-image">
            <a href="post.html"><span class="imghover_medium_blog"></span><img src="images/post1-med.jpg" alt="" /></a>
          </div>
          <div class="blog-medium-text">
            <h1><a href="post.html">Mauris nec velit tortor, quis euismod</a></h1>

            <p class="blog-medium-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel enim sem, in vulputate augue. Praesent vitae velit convallis sapien varius accumsan sit amet eu lacus.<br />
              <a href="post.html" class="read_more">Continue reading &rarr;</a></p>
          </div>
          <div class="blog-medium-text">
            <p class="blog-info"><img src="images/icon-time.png" alt="" />March 14, 2012
              <img src="images/sep.gif" alt="" /><img src="images/icon-comment.png" alt="" />0 Comment(s)
            </p>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="blog-medium-text">
            <p class="blog-info"><img src="images/icon-time.png" alt="" />February 22, 2012
              <img src="images/sep.gif" alt="" /><img src="images/icon-comment.png" alt="" />7 Comment(s)
            </p>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="blog-medium-text">
            <p class="blog-info"><img src="images/icon-time.png" alt="" />January 28, 2012
              <img src="images/sep.gif" alt="" /><img src="images/icon-comment.png" alt="" />26 Comment(s)
            </p>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="blog-medium-text">
            <p class="blog-info"><img src="images/icon-time.png" alt="" />January 14, 2012
              <img src="images/sep.gif" alt="" /><img src="images/icon-comment.png" alt="" />0 Comment(s)
            </p>
          </div>
        </li>
