...
<!-- STYLER FOR DEMO -->
<div id="styler">
  <div id="styler-button"><a href="#"><img src="<c:url value='/resources/images/styler-button.png'/>" alt="styler" /></a></div>

  <div class="styler-title"><img src="<c:url value='/resources/images/styler-t1.png'/>" alt="" /></div>
  ...
  <div class="styler-title"><img src="<c:url value='/resources/images/styler-t2.png'/>" alt="" /></div>
...
<div id="wrapper">
  ...
  <div id="page">
    <div id="content">
      ...
      <div class="slider-nivo-holder">
        <div id="slider-nivo">
          <img src="<c:url value='/resources/images/nivoslider1.jpg'/>" alt="" />
          <img src="<c:url value='/resources/images/nivoslider2.jpg'/>" alt="" />
          <img src="<c:url value='/resources/images/nivoslider3.jpg'/>" alt="" />
        </div>
      </div>
      ...
      <div class="small_icons">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list1.png'/>" alt="" /></div>
      ...
      <div class="small_icons">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list2.png'/>" alt="" /></div>
      ...
      <div class="small_icons-last">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list3.png'/>" alt="" /></div>
      ...
      <div class="small_icons">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list4.png'/>" alt="" /></div>
      ...
      <div class="small_icons">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list5.png'/>" alt="" /></div>
      ...
      <div class="small_icons-last">
        <div class="small_icon-img"><img src="<c:url value='/resources/images/icon_list6.png'/>" alt="" /></div>
  ...
  <div id="sidebar">
    ...
    <ul id="sidebar-bottom">
      <li><a href="#"><img src="<c:url value='/resources/images/sidebar_icons/facebook.png'/>" alt="" /></a></li>
      <li><a href="#"><img src="<c:url value='/resources/images/sidebar_icons/twitter.png'/>" alt="" /></a></li>
      <li><a href="#"><img src="<c:url value='/resources/images/sidebar_icons/rss.png'/>" alt="" /></a></li>
    </ul>
...
<!-- BACKGROUND SLIDER -->
<div id="bg_slider">
  <img src="<c:url value='/resources/images/bgslider-1.jpg'/>" alt="" />
  <img src="<c:url value='/resources/images/bgslider-2.jpg'/>" alt="" />
  <img src="<c:url value='/resources/images/bgslider-3.jpg'/>" alt="" />
</div>
