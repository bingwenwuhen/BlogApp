...
<head>
  ...
  <script type="text/javascript" src="js/quicksand_call.js"></script>
...
<div id="wrapper">
  ...
  <div id="page">
    <div id="content">
      ...
      <ul class="galleries">
        <li>
          <a href="images/gallery-1-tn.jpg" class="fancybox" rel="external">
            <span class="imghover_gallery"></span>
            <img src="images/gallery-1-tn.jpg" alt="" />
          </a>
        </li>
        <li>
          <a href="images/gallery-1-tn.jpg" class="fancybox" rel="external">
